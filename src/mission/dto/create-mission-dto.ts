...
import { IsDate, IsDateString, IsDefined, IsNumber, IsNumberString, IsOptional, IsString } from 'class-validator';
...
export class CreateMissionDto {
  ...
  @IsDefined()
  @IsNumberString(null, { message: "Le montant doit être un nombre" })
  amount: number;
